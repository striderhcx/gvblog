  ...
  <div class>
    ...
    <div v-if="vShow" class="ui top attached teal segment">
      <div
        ...
        v-for="(item,index) in pageBlog.data"
        :key="'content'+index"
      >
        <div class="ui middle aligned mobile reversed stackable grid">
          <div class="eleven wide column">
            ...
            <p class="m-text" v-highlight v-html="marked_content(item.content)"></p>
            <div class="ui grid">
              <div class="row">
                ...
                <div class="right aligned ten wide column">
                  <router-link
                    :to="'/categoryblog/'+item.category_id"
    ...
    <!--footer-->
    <div class="ui bottom attached segment" v-if="pageBlog.pagination.total_page>1">
      <div class="ui middle aligned two column grid">
        <div class="column">
          <a
            @click="thisPageJump(-1)"
            v-if="this.pageBlog.pagination.has_pre"
        ...
        <div class="right aligned column">
          <a
            @click="thisPageJump(+1)"
            v-if="!this.pageBlog.pagination.hax_next"
            class="ui mini teal basic button"
          >下一页</a>
        </div>
      </div>
