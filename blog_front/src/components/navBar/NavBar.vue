    ...
    <div class="ui container">
      <div class="ui inverted secondary stackable menu">
        <h2 class="ui teal header item">
          ...
          <span class="blog-logo">ihxnblog</span>
        </h2>
        <a
          @click="navjump('/ihxnblog')"
          class="item"
          :class="{'active':$route.path.indexOf('/ihxnblog')!=-1,'m-mobile-hide':toggleClass}"
        >
          <i class="mini home icon"></i>首页
        </a>
        <a
          @click="navjump('/categoryblog')"
          class="item"
          :class="{active:$route.path.indexOf('/categoryblog')!=-1,'m-mobile-hide':toggleClass}"
        >
          <i class="mini idea icon"></i>分类
        </a>
        <a
          @click="navjump('/tagblog')"
          class="item"
          :class="{active:$route.path.indexOf('/tagblog')!=-1,'m-mobile-hide':toggleClass}"
        >
        ...
        >
          <i class="mini info icon"></i>关于ihxn
        </a>
        <a
        ...
        <div class="right item" :class="{'m-mobile-hide':toggleClass}">
          <div class="ui icon inverted transparent input m-margin-tb-tiny">
            <input type="text" v-model="searchKey" placeholder="Search...."  @keyup.enter="search"/>
