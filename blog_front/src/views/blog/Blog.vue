      ...
      <div class="ui container">
        <div class="ui top attached segment">
          <div class="ui horizontal link list">
            ...
            <div class="item">
              ...
              <span>{{ blog.updated_time }}</span>
            </div>
            <div class="item">
              <i class="hand pointer icon"></i>
              <span>被看了多少次占位符号</span>
            </div>
            <div class="item">
              <i class="comment alternate outline icon"></i>
              <span>被评论了多少次占位符号</span>
            </div>
          </div>
        </div>
        ...
        <div class="ui attached padded segment">
          ...
          <div class="ui right aligned basic segment">
            <div class="ui orange basic label">flag标记原创</div>
          </div>
  ...
  activated() {
    if (this.$route.params.bid) {
      request({
        url: "/post/detail",
        method: 'get',
        params: { post_id: this.$route.params.bid },
        }).then( res => {
          this.blog = res.data
      ...
      $.get({
        url: "contacts",
        success: res => {
          this.contacts = "1225427292@qq.com";
        }
      });
    } else {
      this.noFindShow = false;
